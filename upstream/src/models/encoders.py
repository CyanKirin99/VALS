...
from upstream.src.utils.tensors import (
    trunc_normal_,
    repeat_interleave_batch
)
from upstream.src.models.position_encoding import PE
...
class Predictor(nn.Module):
    ...
    def forward(self, ctx_rep, tgt_shp, cxt_indices, tgt_indices, num_tgt_blk):
        ...
        for blk in self.predictor_blocks:
            concat_tokens = blk(concat_tokens)
